/**
 * Métodos de PROTOCOLO na telemetria (src/instrument.ts: protocolNamesFromBody
...
import { protocolNamesFromBody, recordProtocolMethods, type RequestTag } from "../src/instrument.js";
