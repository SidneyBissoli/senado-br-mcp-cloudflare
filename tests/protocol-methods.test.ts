/**
 * Métodos de PROTOCOLO na telemetria (src/instrument.ts: protocolMessagesFromBody
...
import { protocolMessagesFromBody, recordProtocolMethods, type RequestTag } from "../src/instrument.js";
...
describe("recordProtocolMethods", () => {
  ...
  it("HTTP ≥ 400 vira desfecho error, e o flag double1 acompanha", () => {
    ...
    expect(points[0]!.doubles).toEqual([1, 0, 0]);
  });
