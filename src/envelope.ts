 ...
 * disso `protocolNamesFromBody` (em src/instrument.ts) tinha a linha `if (status < 400) continue`, com
 ...
 * gravou, e a reconciliação por nome (src/instrument.ts) só vale aí.
 *
